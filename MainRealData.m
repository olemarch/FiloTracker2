...
function [Mshow, M, Lines, ROIs]= MainRealData(MakeDirectory,numF)
...
for i=1:numberF
    ...
    matFileName = regexprep(MovieFileName, '.tif', '.mat')
    StartFrame = 1;
    ...
    dlmwrite(regexprep(MovieFileName, '.tif', '.csv'),[(1:numel(Length))' Length']);
    close all
    clear all
end;
